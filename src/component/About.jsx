      ...
      <div className="container py-5 my-5">
        <div className="row">
          <div className="col-md-6">
            <h1 className="display-6 fw-bolder mb-4">Nosotros</h1>
            ...
            <NavLink to="/contact" className="btn btn-outline-dark px-3">Contactanos</NavLink>
          </div>
          <div className="col-md-6 d-flex justify-content-center">
            <img src="/assets/about.png" alt="Nosotros" height="500px" width="700px" />
          </div>
        </div>
      </div>
    </div>
